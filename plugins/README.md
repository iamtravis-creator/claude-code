...
| [claude-skills](./claude-skills/) | 348 production-ready skill packages across 18 domains (engineering, marketing, C-level advisory, product, compliance, project management, finance, research, and more), imported from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) | **Skills:** hundreds of domain skills under `agents/`, `engineering/`, `marketing-skill/`, `c-level-advisor/`, `product-team/`, `compliance-os/`, and other domain directories |
...
| [obsidian](./obsidian/) | Read and write notes in an Obsidian vault: create notes with proper frontmatter/wikilinks, manage daily notes, search by tag or content, and audit link health | **Commands:** `/obsidian-note`, `/obsidian-daily`, `/obsidian-links`<br>**Skill:** `obsidian-vault` - Vault conventions (wikilinks, frontmatter, tags, Dataview compatibility) |
